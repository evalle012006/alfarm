  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-accent mb-4">Our Core Values</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="card text-center">
              ...
              <h3 className="text-xl font-bold text-accent mb-3">Environmental Stewardship</h3>
            ...
            <div className="card text-center">
              <div className="text-5xl mb-4">⭐</div>
              <h3 className="text-xl font-bold text-accent mb-3">Guest Excellence</h3>
              <p className="text-gray-600">
            ...
            <div className="card text-center">
              <div className="text-5xl mb-4">🤝</div>
              <h3 className="text-xl font-bold text-accent mb-3">Community Impact</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-accent mb-8 text-center">What Makes Us Special</h2>
            
            <div className="space-y-6">
              <div className="flex items-start space-x-4 bg-primary/5 p-6 rounded-lg">
                <div className="text-3xl">✅</div>
                <div>
                  <h3 className="text-xl font-bold text-accent mb-2">150+ Acres of Natural Beauty</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start space-x-4 bg-secondary/5 p-6 rounded-lg">
                <div className="text-3xl">✅</div>
                <div>
                  <h3 className="text-xl font-bold text-accent mb-2">World-Class Adventure Facilities</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start space-x-4 bg-primary/5 p-6 rounded-lg">
                <div className="text-3xl">✅</div>
                <div>
                  <h3 className="text-xl font-bold text-accent mb-2">Eco-Friendly Accommodations</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start space-x-4 bg-secondary/5 p-6 rounded-lg">
                <div className="text-3xl">✅</div>
                <div>
                  <h3 className="text-xl font-bold text-accent mb-2">Farm-to-Table Dining</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start space-x-4 bg-primary/5 p-6 rounded-lg">
                <div className="text-3xl">✅</div>
                <div>
                  <h3 className="text-xl font-bold text-accent mb-2">Expert Guides & Staff</h3>
                  <p className="text-gray-700">
